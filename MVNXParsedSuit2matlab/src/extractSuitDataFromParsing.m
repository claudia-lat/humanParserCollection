...
bucket.pathToSuitData   = fullfile(pwd,'data/parsedFromMvnx');
% -----
% from XML file:
% generic info, points, identity/tpose/tpose-isb
bucket.XMLfilename = fullfile(bucket.pathToSuitData,'Subj.xml');
mvnxData = xml_read(bucket.XMLfilename);
% -----
% from LOG file:
% segment and sensor list
bucket.LOGfilename = fullfile(bucket.pathToSuitData,'Subj.log');
...
bucket.CSVfilename = fullfile(bucket.pathToSuitData, 'Subj.csv');
